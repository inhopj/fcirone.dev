...
const Feeds = ({
  ...
  // Sufficiently random since not so many items (thirty Feeds returned by EchoJs)
  ...
  return (
    <>
      ...
      {items.length == 0 &&
        <Card
          className='text-zinc-600 dark:text-zinc-400 w-6/12 p-5'
          centerText
          title='Oops!'
          subtitle='Something went wrong retriving feeds'
        />
      }
    </>
  )
